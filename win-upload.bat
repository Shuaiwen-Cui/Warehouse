...
@REM git push -f https://github.com/Shuaiwen-Cui/Warehouse.git main
git push -f https://github.com/Shuaiwen-Cui/Warehouse.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Warehouse.git
